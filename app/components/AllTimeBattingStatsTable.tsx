        ...
        <table className="w-full text-xs">
          ...
          <tbody className="divide-y divide-gray-700">
            {sortedPlayers.map((player, index) => {
              ...
              const average =
                (stats.totalInnings - stats.notOuts) > 0 ? (stats.totalRuns / (stats.totalInnings - stats.notOuts)).toFixed(1) : '0.0';
              ...
              return (
                ...
                >
                  ...
                  <td className="px-2 py-2 sm:px-4 sm:py-3 text-center font-semibold">{stats.totalRuns}</td>
                  ...
                  <td className="px-2 py-2 sm:px-4 sm:py-3 text-center font-medium">{stats.totalFours}</td>
                  <td className="px-2 py-2 sm:px-4 sm:py-3 text-center font-medium">{stats.totalSixes}</td>
